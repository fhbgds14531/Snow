...
//=======================================================
	...
	private Timer timer = new Timer(240.0f);
	...
	private void updateFrequencyAndHandicap() {
	...
	public void advanceLevel() {
		if(levelNum < maxLevel){
			...
			save();
			isPaused = false;
			al.playSound("upLevel", 1, 1, false);
			Display.setTitle(title + " Level: " + levelNum + " Total Deaths: " + totalDeaths + " (" + lives + " lives remaining)");
		}else{
			flakes = new HashMap<Float[], Flake>();
	...
	public void decrementLevel(){
		...
		Display.setTitle(title + " Level: " + levelNum + " Total Deaths: " + totalDeaths + " (" + lives + " lives remaining)");
		changeColors();
		al.playSound("downLevel", 1, 1, false);
	}
	...
	public void handleDeath(){
		...
		Display.setTitle(title + " Level: " + levelNum + " Total Deaths: " + totalDeaths + " (" + lives + " lives remaining)");
		al.playSound("death", 1, 0.25f, false);
		for(int i = 0; i < 20; i++){
